...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'NewPage,Preview,Templates,Cut,Copy,Paste,PasteText,PasteFromWord,About,ShowBlocks,TextColor,BGColor,Iframe,PageBreak,SpecialChar,Smiley,Table,Flash,Image,Link,Unlink,Anchor,Language,BidiRtl,BidiLtr,Blockquote,CreateDiv,Outdent,Indent,NumberedList,BulletedList,CopyFormatting,RemoveFormat,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Scayt,SelectAll,Find,Replace,Undo,Redo';
};