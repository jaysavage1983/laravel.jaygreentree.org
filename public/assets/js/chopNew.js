...
async function startCountdown() {
    ...
    const service = await fetch("https://jaygreentree.live/graphql", {
            method: "POST",
            headers: {
    ...
    if (!service.data.currentService || !service.data.currentService.id) {
        ...
        document.getElementById("countdown").innerHTML = "Livestream has ended";
        return;
    }
    ...
    const intervalId = setInterval(function() {
        ...
        document.getElementById("countdown").innerHTML =
          "<div><ul class='fa-ul'><li><span class='days'>" +
          days +
